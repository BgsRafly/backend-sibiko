...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2026 at 11:02 AM
...
(5, '2408561062', 1, 'Konsultasi Masalah Belajar', 'Saya merasa sulit fokus saat kuliah daring.', 'Konseling Individu', '2026-01-03 06:47:09', '2026-01-20 10:00:00', 'reschedule', 'Mahasiswa memerlukan penanganan psikolog klinis di tingkat Universitas karena indikasi depresi berat.', 'Universitas', NULL, NULL, NULL);
...
('laravel-cache-86661923a619c56d32390f6520b52426', 'i:1;', 1767437914),
('laravel-cache-86661923a619c56d32390f6520b52426:timer', 'i:1767437914;', 1767437914),
...
('2408561062', 18, 1, 'Bagus Adi Kusuma', 'Informatika', 'bagus.adi@student.univ.ac.id', '081234567890', '2026-01-02 21:50:50', '2026-01-03 02:59:53');
...
(8, '2026_01_03_095449_create_ajuan_table', 0),
(9, '2026_01_03_095449_create_cache_table', 0),
(10, '2026_01_03_095449_create_cache_locks_table', 0),
(11, '2026_01_03_095449_create_failed_jobs_table', 0),
(12, '2026_01_03_095449_create_job_batches_table', 0),
(13, '2026_01_03_095449_create_jobs_table', 0),
(14, '2026_01_03_095449_create_mahasiswa_table', 0),
(15, '2026_01_03_095449_create_password_reset_tokens_table', 0),
(16, '2026_01_03_095449_create_personal_access_tokens_table', 0),
(17, '2026_01_03_095449_create_sessions_table', 0),
(18, '2026_01_03_095449_create_staff_table', 0),
(19, '2026_01_03_095449_create_users_table', 0),
(20, '2026_01_03_095452_add_foreign_keys_to_ajuan_table', 0),
(21, '2026_01_03_095452_add_foreign_keys_to_mahasiswa_table', 0),
(22, '2026_01_03_095452_add_foreign_keys_to_staff_table', 0),
(23, '2026_01_03_100442_create_surat_rujukan_table', 5);
...
(19, 'App\\Models\\User', 22, 'auth-token', '0c5266e37dc837896a1f7ef45e44b3c9e1a20b50e472c0aeed9ae930951da38e', '[\"*\"]', '2026-01-03 02:57:34', NULL, '2026-01-02 23:14:14', '2026-01-03 02:57:34'),
...
(22, 'App\\Models\\User', 18, 'auth-token', 'c9de39857b78eb0644fdcdd8fa5ab7a1a07bced0d0064b5c2dacbb63bb6331f7', '[\"*\"]', '2026-01-03 02:59:53', NULL, '2026-01-03 02:58:14', '2026-01-03 02:59:53');
...
CREATE TABLE `surat_rujukan` (
  ...
  `keterangan_universitas` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `surat_rujukan` (`id_surat`, `id_ajuan`, `nomor_surat`, `keterangan_universitas`, `tanggal_cetak`, `created_at`, `updated_at`) VALUES
(1, 5, 'SR/5/WD3/2026', 'Mahasiswa memerlukan penanganan psikolog klinis di tingkat Universitas karena indikasi depresi berat.', '2026-01-03', '2026-01-03 02:40:51', '2026-01-03 02:40:51');
...
ALTER TABLE `surat_rujukan`
  ...
  ADD KEY `surat_rujukan_id_ajuan_foreign` (`id_ajuan`);
...
--
ALTER TABLE `surat_rujukan`
  MODIFY `id_surat` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `surat_rujukan`
  ADD CONSTRAINT `surat_rujukan_id_ajuan_foreign` FOREIGN KEY (`id_ajuan`) REFERENCES `ajuan` (`id_ajuan`) ON DELETE CASCADE;
COMMIT;
